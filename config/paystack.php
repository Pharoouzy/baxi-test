...
return [
    ...
    'test' => [
        'secret_key' => env('PAYSTACK_SECRET_KEY', 'sk_test_c6cec3d09ddfea187b6e57eb6b661d8463670669'),
        'public_key' => env('PAYSTACK_PUBLIC_KEY', 'pk_test_b86e31a4a6f091738f6549f9f997128bd36a6639'),
    ],
